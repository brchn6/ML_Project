"""
This script was used to test the feature importance on the copulaGANS generated balanced train set on 15 different seeds.
...
This is the feature importance script used BEFORE the hyperparameter tuning.
Feature importance was also done after hyperparameter tuning.

After the feature importance it was decided to drop the 10 features with the lowest importance.
"""
